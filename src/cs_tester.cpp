...
int main(int argc, char **argv)
{
  ...
  start_p.position.y = 0.05;
  start_p.position.z = 0.05;
  //                      w       x       y       z
  ...
  std::stringstream ss;
  ss << "Orientation: x=" << grip.x() << " y=" << grip.y() << " z=" << grip.z() << " w=" << grip.w();
  ROS_INFO(ss.str().c_str());
  low_p1.position.x = 0.25;
  low_p1.position.y = 0.00;
  low_p1.position.z = 0.05;
  ...
  end_p.position.y = 0.00;
  end_p.position.z = 0.05;
